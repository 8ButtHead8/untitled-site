...
const faqData = [
  { q: "Мне уже за 40 — поздно менять", a: "Я сама нашла призвание в 50 лет, после науки, госслужбы и HR. Возраст — это не ограничение, это накопленный опыт. Именно взрослые клиенты чаще всего уходят с чёткой, реалистичной картиной." },
  { q: "Я не знаю, что мне нравится", a: "Это нормально — и именно с этим я помогаю. Я умею находить интересы там, где человек давно перестал их замечать." },
  { q: "Я пробовал переходить — не получилось", a: "Хаотичные попытки редко работают. На консультации мы разберём, почему предыдущие переходы не сложились, и что делать по-другому." },
  { q: "Это дорого", a: "Консультация стоит 2 950 рублей. Это дешевле одного месяца тревожного бездействия. 2–3 встречи — конкретный вектор." },
];
    ...
    <div style={{ background: "var(--cream)", overflowX: "hidden" }}>
      ...
      <div style={{
        ...
        <div className="hero-left" style={{
          ...
          <p style={{ fontSize: 16, color: "rgba(255,255,255,.68)", maxWidth: 420, marginBottom: 48, lineHeight: 1.75, animation: "fadeUp .65s .32s ease both" }}>
            Я нашла своё призвание в{" "}
            <strong style={{ color: "rgba(255,255,255,.9)", fontWeight: 600 }}>50 лет</strong>.
            Знаю изнутри, каково это — искать себя. И помогаю другим сделать это{" "}
            <strong style={{ color: "rgba(255,255,255,.9)", fontWeight: 600 }}>за 2–3 встречи</strong>.
          </p>
      ...
      <div className="aha-strip" style={{ background: "var(--amber-pale)", textAlign: "center", padding: "72px 52px", borderTop: "3px solid var(--amber)", borderBottom: "3px solid var(--amber)" }}>
        ...
        <p style={{ color: "var(--muted)", fontSize: 17, maxWidth: 520, margin: "0 auto 40px" }}>
          Ответьте на 7 вопросов. Я получу первичное представление о вашем запросе и честно скажу, поможет ли консультация именно вам.
        </p>
        ...
        <div style={S.container}>
          ...
          <div className="benefits-grid">
            {[
              ...
              { n: "3", icon: "💪", h: "Уверенность, что всё решаемо", p: "Я сама нашла призвание в 50 лет. Взрослые клиенты это чувствуют — и именно они чаще всего уходят с чёткой картиной." },
              ...
              <div style={{ background: "var(--green)", position: "sticky", top: 88 }}>
                ...
                <div style={{ padding: "36px 40px 44px" }}>
                  ...
                  <p style={{ color: "rgba(255,255,255,.6)", fontSize: 15, marginBottom: 32 }}>
                    7 вопросов о вашей ситуации. Я честно скажу, чем смогу помочь.
                  </p>
      ...
      <section className="section-pad" style={S.section}>
        <div style={S.container}>
          ...
          <div className="steps-grid">
            {[
              { n: "01", tag: "Бесплатно · 5 минут", h: "Квиз", p: "Расскажите о текущей ситуации и вашем запросе. Я заранее понимаю контекст и прихожу на встречу подготовленной." },
              { n: "02", tag: "Онлайн · 60–90 минут", h: "Консультация", p: "Разбираем ваш опыт, ценности, страхи, возможности. Я работаю без осуждения и без шаблонов — с реальной историей каждого человека." },
        ...
        <div className="photo-banner-overlay" style={{
          ...
          <div style={{ maxWidth: 480 }}>
            ...
            <p style={{ color: "rgba(255,255,255,.72)", fontSize: 16, lineHeight: 1.72 }}>
              13 лет в науке, Министерство занятости, корпоративный HR — и только в 50 нашла то, что по-настоящему моё. Клиенты в возрасте 35–50 это чувствуют: разговор с тем, кто прошёл через это сам.
            </p>
          </div>
        </div>
      </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "340px 1fr", gap: 72, alignItems: "start" }} className="about-grid">
            ...
            <div>
              ...
              <p style={{ fontSize: 16, color: "var(--muted)", lineHeight: 1.75 }}>
                Специализируюсь на профориентации подростков и взрослых. Работаю онлайн — по всей России.
              </p>
              <div className="creds">
      ...
      {/* ── REVIEWS ── */}
      <ReviewsBlock
        ids={["alisa", "natalia", "tatiana"]}
        title={"Что говорят те,\nкто уже нашёл себя"}
        subtitle="Реальные отзывы взрослых клиентов Светланы."
      />
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 72, alignItems: "start" }} className="form-grid">
            <div>
              ...
              <p style={{ color: "var(--muted)", fontSize: 16, lineHeight: 1.72, marginBottom: 28 }}>
                Ответьте на несколько вопросов — и я покажу что именно происходит и как работа со мной поможет в вашем случае. После квиза можно записаться на бесплатную 15-минутную встречу.
              </p>
            ...
            <div className="form-box">
              ...
              <p style={{ fontSize: 15, color: "var(--muted)", marginBottom: 36 }}>
                15 минут онлайн. Уточним вашу ситуацию, составим план консультаций и ответим на ваши вопросы.
              </p>
