...
const faqData = [
  { q: "Ребёнок не захочет разговаривать с незнакомым человеком", a: "Это нормально — так почти у всех. Я работаю с подростками много лет и умею разговорить даже самых закрытых. Первые минуты уходят на то, чтобы ребёнок расслабился. К середине встречи они сами не хотят заканчивать." },
  { q: "Мы уже проходили тесты — результат был бесполезным", a: "Тесты дают направление, а не ответ. Я работаю с живым разговором — именно поэтому результат конкретный, а не список из 40 профессий без объяснений." },
  { q: "Не знаем, подойдёт ли это именно нашему ребёнку", a: "Для этого и нужен квиз — он бесплатный. Пройдите его, и я честно скажу, подойдёт ли консультация вашей ситуации." },
  { q: "Это дорого", a: "Консультация стоит 2 950 рублей. Это дешевле одного месяца обучения на ненужной специальности. Дешевле года сомнений. 2–3 встречи — конкретный результат." },
];
    ...
    <div style={{ background: "var(--cream)", overflowX: "hidden" }}>
      ...
      <div style={{
        ...
        <div className="hero-left" style={{
          ...
          <p style={{ fontSize: 16, color: "rgba(255,255,255,.68)", maxWidth: 420, marginBottom: 48, lineHeight: 1.75, animation: "fadeUp .65s .32s ease both" }}>
            Не тест из интернета — живой разговор со мной,{" "}
            <strong style={{ color: "rgba(255,255,255,.9)", fontWeight: 600 }}>кандидатом наук</strong>{" "}
            и профориентологом.
            Ваш ребёнок поймёт куда поступать — за 2–3 встречи.
          </p>
        ...
        <div className="hero-image" style={{ position: "relative", overflow: "hidden" }}>
          ...
          <div className="hero-overlay" style={{
            ...
            <div className="hero-stats" style={{ display: "flex", gap: 28, marginTop: 24, paddingTop: 20, borderTop: "1px solid rgba(255,255,255,.2)" }}>
              {[
                { n: "100+", l: "часов консультаций" },
                { n: "5 000", l: "человек обучила" },
                { n: "26", l: "лет преподаю" },
                { n: "52", l: "научных статьи" },
              ].map((s) => (
      ...
      <div className="aha-strip" style={{ background: "var(--amber-pale)", textAlign: "center", padding: "72px 52px", borderTop: "3px solid var(--amber)", borderBottom: "3px solid var(--amber)" }}>
        ...
        <p style={{ color: "var(--muted)", fontSize: 17, maxWidth: 520, margin: "0 auto 40px" }}>
          Ответьте на 8 вопросов. Я получу первичное представление о ситуации и честно скажу, подойдёт ли консультация именно вам.
        </p>
      ...
      <section className="section-pad" style={S.section}>
        <div style={S.container}>
          ...
          <div className="steps-grid">
            {[
              { n: "01", tag: "Бесплатно · 5 минут", h: "Квиз", p: "Отвечаете на 8 вопросов о ребёнке — его интересах, ситуации, что уже пробовали. Я прихожу на встречу подготовленной." },
              { n: "02", tag: "Онлайн · 60–90 минут", h: "Консультация", p: "Встреча с ребёнком. Разбираем склонности, интересы, мотивацию. Я умею разговорить даже самых закрытых подростков — к середине они сами не хотят заканчивать." },
        ...
        <div className="photo-banner-overlay" style={{
          ...
          <div style={{ maxWidth: 480 }}>
            ...
            <p style={{ color: "rgba(255,255,255,.72)", fontSize: 16, lineHeight: 1.72 }}>
              До профориентации — 13 лет в науке, Министерство занятости, корпоративный HR. Мой собственный опыт поиска себя делает каждую консультацию настоящей.
            </p>
          </div>
        </div>
      </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "340px 1fr", gap: 72, alignItems: "start" }} className="about-grid">
            ...
            <div>
              ...
              <p style={{
                ...
                «Я знаю как сложно найти любимое дело. Смогла найти своё призвание только в 50 лет — и теперь помогаю другим не тратить годы на поиск того, что можно найти за 2–3 встречи.»
              </p>
              <p style={{ fontSize: 16, color: "var(--muted)", marginBottom: 20, lineHeight: 1.75 }}>
                Профориентолог, преподаватель, наставник. Кандидат социологических наук. Работаю онлайн по всей России.
              </p>
              <p style={{ fontSize: 16, color: "var(--muted)", marginBottom: 20, lineHeight: 1.75 }}>
              ...
              <p style={{ fontSize: 16, color: "var(--muted)", lineHeight: 1.75 }}>
                Прошла специализированную подготовку по профориентации подростков в Академии WhoAmI. Работаю онлайн — по всей России.
              </p>
              <div className="creds">
      ...
      {/* ── REVIEWS ── */}
      <ReviewsBlock
        ids={["shvyreva", "karina", "olga"]}
        title={"Что говорят те,\nкто обратился к Светлане"}
        subtitle="Реальные отзывы клиентов — родителей и взрослых."
      />
        ...
        <div style={S.container}>
          ...
          <div className="vs-grid">
            ...
            <div className="vs-card featured">
              <p className="vs-label">Я, Светлана Жукова</p>
              <h3 className="vs-h">Один человек. Конкретный результат.</h3>
              <p className="vs-p">Видите кто работает с вашим ребёнком — мою историю и статьи. Квиз даёт мне контекст ещё до встречи. Напрямую, без посредников.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 72, alignItems: "start" }} className="form-grid">
            <div>
              ...
              <p style={{ color: "var(--muted)", fontSize: 16, lineHeight: 1.72, marginBottom: 28 }}>
                Ответьте на несколько вопросов — и я покажу что происходит с ребёнком и как именно смогу помочь. После квиза можно записаться на бесплатную 15-минутную встречу.
              </p>
              <Link href="/quiz/parents" className="btn-amber" style={{ marginBottom: 32, display: "inline-block" }}>
                Пройти квиз →
              </Link>
              <p style={{ fontSize: 14, marginBottom: 16 }}>Не готовы к квизу? Просто оставьте контакт — я напишу сама.</p>
              <a
                href={TELEGRAM_URL}
                target="_blank"
            ...
            <div className="form-box">
              ...
              <p style={{ fontSize: 15, color: "var(--muted)", marginBottom: 36 }}>
                15 минут онлайн. Уточним ситуацию с ребёнком, составим план консультаций и ответим на ваши вопросы.
              </p>
